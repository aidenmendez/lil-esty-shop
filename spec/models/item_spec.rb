...
describe Item do
  ...
  describe 'instance methods' do
    it 'best day' do
      ...
      @invoice_3 = Invoice.create!(merchant_id: @merchant1.id, customer_id: @customer_2.id, status: 2,  created_at: "2012-03-28 14:54:09")
      ...
      @ii_1 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 9, unit_price: 10, status: 2, created_at: "2012-03-28 14:54:09")
      @ii_2 = InvoiceItem.create!(invoice_id: @invoice_2.id, item_id: @item_1.id, quantity: 19, unit_price: 10, status: 2, created_at: "2012-03-28 14:54:09")
      @ii_3 = InvoiceItem.create!(invoice_id: @invoice_3.id, item_id: @item_2.id, quantity: 2, unit_price: 8, status: 2)
      @ii_4 = InvoiceItem.create!(invoice_id: @invoice_4.id, item_id: @item_3.id, quantity: 3, unit_price: 5, status: 1)
      @ii_6 = InvoiceItem.create!(invoice_id: @invoice_5.id, item_id: @item_4.id, quantity: 1, unit_price: 1, status: 1)
      @ii_7 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_1.id, quantity: 1, unit_price: 3, status: 1,  created_at: "2012-02-28 14:54:09")
      @ii_8 = InvoiceItem.create!(invoice_id: @invoice_7.id, item_id: @item_1.id, quantity: 1, unit_price: 5, status: 1,  created_at: "2012-02-28 14:54:09")
      @ii_9 = InvoiceItem.create!(invoice_id: @invoice_7.id, item_id: @item_1.id, quantity: 1, unit_price: 1, status: 1,  created_at: "2012-01-28 14:54:09")
      ...
      expect(@item_1.best_day).to eq(@ii_2.created_at.to_date)
      expect(@item_1.best_day).to_not eq(@ii_9.created_at.to_date)
    end
    ...
    it "get_discount" do
      ...
      expect(@item_1.get_discount(@ii_1.quantity)).to eq([@discount1])
      expect(@item_2.get_discount(@ii_2.quantity)).to eq([@discount4])
